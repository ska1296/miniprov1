...
public class ReadContent extends JFrame implements ActionListener {
	...
	public ReadContent() {
		...
		try
		{
			...
			sock=new Socket("localhost",6006); //Creates a stream socket and connects it to the specified port number on the named host
